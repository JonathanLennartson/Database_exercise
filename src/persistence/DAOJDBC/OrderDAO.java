...
//		PreparedStatement statement = connection.prepareStatement("SELECT * FROM orders");
	...
	public Customer bestCustomer() throws SQLException {
		Connection connection = ConnectionFactory.getConnection();
		PreparedStatement statement = connection.prepareStatement("select customer_id, name, total from orders_view order by total asc;");
		ResultSet rs = statement.executeQuery();
		...
		while(rs.next()) {
			...
			customer.setTotalPayment(rs.getInt("total"));
		}
